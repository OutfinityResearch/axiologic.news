...
fs.rm("./src/apihub-root/external-volume/lightDB", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});
...
fs.rm("./src/apihub-root/external-volume/secrets", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});

fs.rm("./src/apihub-root/external-volume/versionlessdsu", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});

fs.rm("./src/apihub-root/external-volume/locks", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});

fs.rm("./src/apihub-root/external-volume/memehit_logs", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});

fs.rm("./src/apihub-root/external-volume/memehit_audit", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});

fs.rm("./src/apihub-root/external-volume/nfts", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});
fs.rm("./apihub-root/nfts", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});
fs.rm("./src/apihub-root/external-volume/balanceData", {recursive: true, force: true}, (err) => {
    if (err) {
        console.error(err);
    }
});
